...
public class CommandRollsc implements ICommand{

	private final List aliases;
     
  
    public CommandRollsc() 
    { 
    ...
    { 
        return "/rollsc x'd'y ex.. /rollsc 1d20"; 
    } 
        	...
        	if(argString[0].equals("9001")) {
        		...
        		if(argString[0].length() <3) {
           		vals = rolls.Roller(1,Integer.parseInt(argString[0]));
           	 		...
           	 		new Messenger(server, (Entity)sender, ERRORComponent, false);
           	 		return;
           	 		}
        ...
        default:
        	...
        	break;
         	...
         	ArrayList<TextComponentString> messages = new ArrayList<TextComponentString>();
            	...
            	new Messenger(server, (Entity)sender, messages, false);
